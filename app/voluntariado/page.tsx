      ...
      >
        ...
        >
          ...
          <div className="relative -mx-4 md:-mx-8">
            <div className="max-w-6xl mx-auto px-4 md:px-8 min-h-[440px]">
              <section className="w-full px-4 md:px-8 pt-12 md:pt-16 pb-16 md:pb-24">
                {/* Full-bleed frosted "Próximamente" band — covers the badge + carousel. */}
            ...
            <ComingSoon
              ...
              subtitle="Las oportunidades de voluntariado estarán disponibles muy pronto."
            />
          </div>
          ...
          <section className="relative w-full px-4 md:px-8 pt-24 md:pt-40 pb-[280px] md:pb-[400px] overflow-hidden">
            ...
            <div className="absolute inset-x-0 top-20 md:top-28 bottom-16 md:bottom-24 pointer-events-none">
            ...
            <div className="relative z-10 max-w-4xl mx-auto text-center">
              ...
              >
                ...
                podés dejar tu perfil cargado y
                <br className="hidden md:inline" /> te contactaremos cuando
                surja una oportunidad acorde.
              </motion.p>
